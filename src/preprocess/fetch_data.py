...
# The user-provided path for the final CSV files.
...
# Mapping of sqlite files to their main table and desired CSV output name
FILE_MAPPING = {
    "data.sqlite": {
        "table_name": "cards",
...
def get_latest_release_assets():
    """Fetches the download URLs for the latest release assets from GitHub."""
...
def main():
    """Main function to download and convert data."""
